...
## 프로젝트 요약
이 프로젝트는 모두의 연구소 산하 교육기관 **AIFFEL**과 **SOCAR**와 연계한 **AIFFELXSOCAR**교육 과정에서 아이카센터가 진행한 **정비 메모를 활용한 자동완성 및 카테고리 분류 어플리케이션** 입니다.    
이 프로젝트는 **정비 용어 자동완성 기능**과 **정비 메모 카테고리 재정의 및 분류** 하는 것을 목표로 진행했습니다.
